...
export default function Banner() {
  return (
    <>
      <div id="default-carousel" class="relative bg-white">
        {/* <!-- Carousel wrapper --> */}
        <div class="relative h-56 overflow-hidden md:h-96">
          ...
          <div
            ...
            data-carousel-item=""
          >
            <span class="absolute text-2xl font-semibold text-white -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 sm:text-3xl">
              First Slide
            </span>
            <img
